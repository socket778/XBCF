...
// predict_gp
Rcpp::List predict_gp(size_t fl, mat y, mat z, mat X, mat Xtest, Rcpp::XPtr<std::vector<std::vector<tree>>> tree_pnt, mat partial_fit, mat sigma0_draws, mat sigma1_draws, mat a_draws, mat b0_draws, mat b1_draws, double theta, double tau, size_t p_categorical, bool verbose, bool parallel, bool set_random_seed, size_t random_seed);
RcppExport SEXP _XBCF_predict_gp(SEXP flSEXP, SEXP ySEXP, SEXP zSEXP, SEXP XSEXP, SEXP XtestSEXP, SEXP tree_pntSEXP, SEXP partial_fitSEXP, SEXP sigma0_drawsSEXP, SEXP sigma1_drawsSEXP, SEXP a_drawsSEXP, SEXP b0_drawsSEXP, SEXP b1_drawsSEXP, SEXP thetaSEXP, SEXP tauSEXP, SEXP p_categoricalSEXP, SEXP verboseSEXP, SEXP parallelSEXP, SEXP set_random_seedSEXP, SEXP random_seedSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(predict_gp(fl, y, z, X, Xtest, tree_pnt, partial_fit, sigma0_draws, sigma1_draws, a_draws, b0_draws, b1_draws, theta, tau, p_categorical, verbose, parallel, set_random_seed, random_seed));
...
static const R_CallMethodDef CallEntries[] = {
    {"_XBCF_predict_gp", (DL_FUNC) &_XBCF_predict_gp, 19},
