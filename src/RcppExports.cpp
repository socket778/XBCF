...
// predict_gp
Rcpp::List predict_gp(size_t fl, mat y, mat z, mat X, mat Xtest, Rcpp::XPtr<std::vector<std::vector<tree>>> tree_pnt, mat partial_fit, mat pitrain, mat pitest, mat sigma0_draws, mat sigma1_draws, mat a_draws, mat b0_draws, mat b1_draws, double theta, double tau, size_t p_categorical, bool verbose, bool parallel, bool set_random_seed, size_t random_seed);
RcppExport SEXP _XBCF_predict_gp(SEXP flSEXP, SEXP ySEXP, SEXP zSEXP, SEXP XSEXP, SEXP XtestSEXP, SEXP tree_pntSEXP, SEXP partial_fitSEXP, SEXP pitrainSEXP, SEXP pitestSEXP, SEXP sigma0_drawsSEXP, SEXP sigma1_drawsSEXP, SEXP a_drawsSEXP, SEXP b0_drawsSEXP, SEXP b1_drawsSEXP, SEXP thetaSEXP, SEXP tauSEXP, SEXP p_categoricalSEXP, SEXP verboseSEXP, SEXP parallelSEXP, SEXP set_random_seedSEXP, SEXP random_seedSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< mat >::type partial_fit(partial_fitSEXP);
    Rcpp::traits::input_parameter< mat >::type pitrain(pitrainSEXP);
    Rcpp::traits::input_parameter< mat >::type pitest(pitestSEXP);
    ...
    Rcpp::traits::input_parameter< mat >::type b0_draws(b0_drawsSEXP);
    Rcpp::traits::input_parameter< mat >::type b1_draws(b1_drawsSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(predict_gp(fl, y, z, X, Xtest, tree_pnt, partial_fit, pitrain, pitest, sigma0_draws, sigma1_draws, a_draws, b0_draws, b1_draws, theta, tau, p_categorical, verbose, parallel, set_random_seed, random_seed));
    return rcpp_result_gen;
END_RCPP
}
// xbcf_predict
Rcpp::List xbcf_predict(mat X, Rcpp::XPtr<std::vector<std::vector<tree>>> tree_pnt);
RcppExport SEXP _XBCF_xbcf_predict(SEXP XSEXP, SEXP tree_pntSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< mat >::type X(XSEXP);
    Rcpp::traits::input_parameter< Rcpp::XPtr<std::vector<std::vector<tree>>> >::type tree_pnt(tree_pntSEXP);
    rcpp_result_gen = Rcpp::wrap(xbcf_predict(X, tree_pnt));
    return rcpp_result_gen;
END_RCPP
}
// r_to_json
